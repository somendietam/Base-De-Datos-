...
CREATE TABLE IF NOT EXISTS `mydb`.`Canciones` (
  ...
  CONSTRAINT `Fk_canciones_albumes`
    ...
    REFERENCES `mydb`.`Albumes` (`idAlbumes`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`Canciones_mas_escuchadas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Canciones_mas_escuchadas` (
...
-- -----------------------------------------------------
-- Table `mydb`.`Artistas_invitados`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Artistas_invitados` (
...
CREATE TABLE IF NOT EXISTS `mydb`.`Usuarios` (
  ...
  CONSTRAINT `Fk_usuario_membresia`
    ...
    REFERENCES `mydb`.`Membresias` (`tipo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
ALTER TABLE `usuarios` 
    ...
    modify column  `nombre_completo` VARCHAR(45),
    modify column  `nombre_de_usuario` VARCHAR(45),
    modify column  `tipo_membresia` VARCHAR(45),
    modify column  `correo` VARCHAR(45),
    modify column  `fecha_registro` DATE,
    modify column  `contraseña` VARCHAR(45),
    modify column  `fecha_nacimiento` DATE,
    modify column  `id_membresia` INT;
	
-- -----------------------------------------------------
-- Table `mydb`.`Artistas_mas_esuchados`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Artistas_mas_esuchados` (
...
-- -----------------------------------------------------
-- Table `mydb`.`Usuario_pagador`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Usuario_pagador` (
  `id_usuario` INT NOT NULL,
...
drop table usuario_pagador; 


-- -----------------------------------------------------
-- Table `mydb`.`Listas_reproduccion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Listas_reproduccion` (
...
-- -----------------------------------------------------
-- Table `mydb`.`Usuarios_con_acceso_a_listas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Usuarios_con_acceso_a_listas` (
  ...
  CONSTRAINT `Fk_ucl_listas`
    ...
    REFERENCES `mydb`.`Listas_reproduccion` (`idListas_reproduccion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Pago` (
  `idPago` INT NOT NULL,
  `id_usuario_pagador` INT NULL,
  `tipo_memb_pagada` VARCHAR(45) NULL,
  ...
  CONSTRAINT `Fk_pago_usuario_pagador`
    ...
    REFERENCES `mydb`.`Usuario_pagador` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
Select idAlbumes,id_artista,nombre from Albumes order by id_artista asc;
...
Select idCanciones,nombre,id_artista_principal,id_album,fecha_publicacion,duracion from canciones order by id_artista_principal asc;
...
-- delete from membresias num_integrantes;
